...
%
%   D = FDESIGN.FRACDELAY(DELTA,'N',4) initializes the filter designer
%   specifications with 'N'and sets the filter order to the value N. 
%
%   D = FDESIGN.FRACDELAY(DELTA,N) uses the  default SPEC ('N') and
...
%   $Revision: 1.1.6.4 $  $Date: 2008/10/31 07:01:01 $
