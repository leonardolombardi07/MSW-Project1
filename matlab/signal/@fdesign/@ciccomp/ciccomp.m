...
%
%   D = FDESIGN.CICCOMP(DELAY, NSECTIONS) constructs a CIC Compensator
%   filter designer with DifferentialDelay set to DELAY and
%   NumberOfSections set to NSECTIONS.  By default these are 2 and 1,
%   respectively.
%
...
%   $Revision: 1.1.6.3 $  $Date: 2005/12/22 19:00:46 $
