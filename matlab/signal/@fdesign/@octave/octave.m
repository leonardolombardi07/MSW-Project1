...
%   <a href="matlab:web([matlabroot,'\toolbox\filterdesign\filtdesdemos\html\octavedemo.html'])">Octave-Band and Fractional-Octave-Band Filters</a> demo. 
%
%   See also FDESIGN, FDESIGN/SETSPECS, FDESIGN/DESIGN.

%   Author(s): V. Pellissier
%   Copyright 2006 The MathWorks, Inc.
%   $Revision: 1.1.6.1 $  $Date: 2006/10/18 03:24:47 $
