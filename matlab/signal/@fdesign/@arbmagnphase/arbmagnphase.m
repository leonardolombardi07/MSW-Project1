...
%   H1 = zeros(size(F1)); H2 = exp(-j*pi*gd*F2); H3 = zeros(size(F3));
%   d  = fdesign.arbmagnphase('N,B,F,H',50,3,F1,H1,F2,H2,F3,H3); 
%   Hd = design(d,'equiripple');
%   fvtool(Hd)
%
%   For more information, see the <a href="matlab:web([matlabroot,'\toolbox\filterdesign\filtdesdemos\html\arbmagnphasedemo.html'])">Arbitrary Magnitude and Phase Demo</a>. 
%
...
%   $Revision: 1.1.6.2 $  $Date: 2005/12/22 19:00:43 $
