function [Spec, f] = spectrum(varargin)
    ...
    %
    %   NOTE: The function form of SPECTRUM is obsolete. It still works but may
    %   be removed in the future. SPECTRUM has been replaced by the SPECTRUM
    %   objects and by other functions, such as PWELCH, TFESTIMATE, and
    %   MSCOHERE.
    %
    %
    ...
    %
    %   For more information, see the <a href="matlab:web([matlabroot,'\toolbox\signal\sigdemos\html\spectralanalysisobjsdemo.html'])">Getting Started Demo</a>.
    ...
    %   $Revision: 1.6.4.9 $  $Date: 2009/05/23 08:13:41 $
    ...
    % Obsolete in 2007a.
    warnStr = sprintf(['SPECTRUM is obsolete and will be removed in future versions.\n', ...
                        'Use the <a href="matlab:help SPECTRUM">spectrum</a> objects instead, type "help SPECTRUM".']);
